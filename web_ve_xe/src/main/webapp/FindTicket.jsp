        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="FindTicket.jsp">Tra cứu vé xe</a>               
              </li>             
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
              <div class="card shadow-lg">
                <div class="card-body p-5">
                  <h1 class="fs-4 card-title fw-bold mb-4">Nhập thông tin vé xe đã đặt</h1>
                  <form method="post"  action="findticket" autocomplete="off">
                   <p class="text-danger">${mess}</p>
                    <div class="mb-3">
                      <label class="mb-2 text-muted" for="ticketID">Mã vé</label>
                      <input id="ticketID" type="text" class="form-control" name="ticketID" value="" required autofocus>
                ...
                <div class="card-footer py-3 border-0">
                  <div class="text-center">
                    Chưa có tài khoản? <a href="Register.jsp" class="text-dark">Create One</a>
                  </div>
                </div>
              </div>
