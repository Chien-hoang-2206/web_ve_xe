            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
              <div class="card shadow-lg">
                <div class="card-body p-5">
                  ...
                  <form method="post"  action="search_ticket" autocomplete="off">
                   <p class="text-danger">${mess}</p>
                    <div class="mb-3">
                      <label class="mb-2 text-muted" for="email">Mã vé</label>
                    ...
                    <div class="mb-3">
                      <div class="mb-2 w-100">
                        <label class="text-muted" for="password">Số điện thoại</label>
                      </div>
