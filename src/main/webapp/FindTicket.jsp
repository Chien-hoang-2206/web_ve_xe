				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div class="card shadow-lg">
						<div class="card-body p-5">
							<h1 class="fs-4 card-title fw-bold mb-4">Nhập thông tin vé
								xe đã đặt</h1>
							<form method="post" action="findticket" autocomplete="off">
								<p class="text-danger">${mess}</p>
								<div class="mb-3">
									<label class="mb-2 text-muted" for="ticketID">Mã vé</label> <input
										id="ticketID" type="text" class="form-control" name="ticketID"
										value="" required autofocus>
									<div class="invalid-feedback">Yêu cầu nhập mã vé</div>
								</div>
								<div class="mb-3">
								...
								<div class="d-flex align-items-center">
									...
									<button type="submit" class="btn btn-primary ms-auto">
										Tra cứu vé xe</button>
								</div>
							</form>
						</div>
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Chưa có tài khoản? <a href="Register.jsp" class="text-dark">Create
									One</a>
							</div>
						</div>
					</div>
