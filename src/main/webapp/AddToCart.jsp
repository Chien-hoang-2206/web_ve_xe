			...
			<div class="row">
				<div class="col-md-8 cart">
					...
					<div class="row border-top border-bottom">
						<div class="row main align-items-center">
							...
							<div class="col">
								<div class="row ">${tripdetail.routeFrom} - ${tripdetail.routeTo} </div>
								<div class="row text-info"> Giờ khởi hành: ${tripdetail.onlyTimeFrom}</div>
								<div class="row text-info"> Giờ đến:  ${tripdetail.onlyTimeTo}</div>
								<div class="row text-muted">${tripdetail.carName}</div>
							</div>
						</div>
					</div>
					<div class="back-to-shop"><a href="AddToCartController">&leftarrow;</a><span class="text-muted">Quay lại trang đặt vé</span></div>
				</div>
				<div class="col-md-4 summary">
					...
					<div class="row">
						...
						<div class="col text-right">${tripdetail.carPrice}</div>
					</div>
					<div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
						<div class="col">TỔNG CỘNG</div>
						<div class="col text-right">${tripdetail.carPrice}</div>
					</div>
					<a class="btn" href="InFoSignUpTicket.jsp">ĐẶT VÉ</a>
				</div>
			</div>
		</div>
