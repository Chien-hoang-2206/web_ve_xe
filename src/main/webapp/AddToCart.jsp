		...
		<div class="card">
			<div class="row">
					...
					<div class="row border-top border-bottom">
						<div class="row main align-items-center">
							...
							<div class="col">
								...
								<div class="row text-info"> Giờ khởi hành: ${tripdetail.timeFrom}</div>
								<div class="row text-info"> Giờ đến:  ${tripdetail.timeTo}</div>
								<div class="row text-muted">${tripdetail.carName}</div>
							</div>
						</div>
					</div>
					<div class="back-to-shop"><a href="../Hienchuyenxe/index.html">&leftarrow;</a><span class="text-muted">Quay lại trang đặt vé</span></div>
				</div>
				<div class="col-md-4 summary">
					...
					<a class="btn" href="infopay">ĐẶT VÉ</a>
				</div>
			</div>
		</div>
