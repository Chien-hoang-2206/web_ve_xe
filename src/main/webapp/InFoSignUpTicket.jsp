				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							<h1 class="fs-4 card-title fw-bold mb-4">Thông tin đặt vé</h1>
							<form method="post" action="infopay" autocomplete="off">
								<div class="mb-3">
									<label class="mb-2 text-muted" for="name">Họ và tên</label> <input
										id="name" type="text" class="form-control" name="nameuser"
								...
								<div class="mb-3">
									<div class="mb-2 w-100">
										<label class="text-muted" for="note">Chú thích</label>
									</div>
									<input id="note" type="text" class="form-control" name="note"
										required>
									<form>
										<label class="mb-2 text-muted" for="payment">Phương
											thức thanh toán:</label> <select id="payment" name="payment">
											<option value="1">Ngân hàng (ATM)</option>
									...
									<button type="submit" class="btn btn-primary ms-auto" >Đăng ký</button>
									</div>
								</div>
							</form>
						</div>
