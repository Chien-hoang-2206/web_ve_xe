        ...
        <div class="card card-1">
            ...
            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <div class="media-body my-auto text-right">
                                        <div class="row  my-auto flex-column flex-md-row">
                                            <div class="col my-auto">
                                                <h6 class="mb-0">${ticketDetal.carName}</h6>
                                            </div>
                                            <div class="col-auto my-auto">
                                                <small>${ticketDetal.userName}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.userPhone}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.userEmail}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.routeFrom}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.routeTo}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.timeFrom}</small>
                                            </div>
                                            <div class="col my-auto">
                                                <small>${ticketDetal.timeTo}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">${ticketDetal.carName}</th>
                        <td>${ticketDetal.userName}</td>
                        <td>${ticketDetal.userPhone}</td>
                        <td>@${ticketDetal.userEmail}</td>
                        <td>${ticketDetal.routeFrom}</td>
                        <td>${ticketDetal.routeTo}</td>
                        <td>${ticketDetal.timeFrom}</td>
                        <td>${ticketDetal.timeTo}</td>
                      </tr>
                    </tbody>
                  </table>
