				...
				<div class="row">
					...
					<div class="col-xs-8 text-right menu-1">
						<ul>
							...
							<li><a href="findticket">Tra cứu vé xe</a></li>
							...
							<c:if test="${sessionScope.acc != null}">
								<li class="has-dropdown"><a href="#">Xin chào
			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						...
						<p>Đặt mua vé xe đi từ ${routeFrom} - ${routeTo} chất lượng
							cao và giá vé ưu đãi nhất: ${numOfListTrip} chuyến</p>
					</div>
				</div>

				<div class="row">
					<c:forEach items="${listTrip}" var="l">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<a href="images/img_1.jpg" class="fh5co-card-item image-popup">
								...
								<div class="fh5co-text">
									...
									<h2 class="card-text show_txt">${l.onlyTimeFrom}-${l.onlyTimeTo}</h2>
								</div>
							</a>
							<div class="col">
								<a href="AddToCartController?TripId=${l.tripID}" class="btn btn-primary">Đặt vé xe</a>
							</div>
						</div>
